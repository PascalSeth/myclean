    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content className="fixed left-[50%] top-[50%] z-50 grid w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-2xl translate-x-[-50%] translate-y-[-50%] gap-4 border-0 bg-transparent p-0 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] mx-4">
          <DialogPrimitive.Title className="sr-only">Pilot Program - We're Live in Pokuase!</DialogPrimitive.Title>
          <motion.div
          ...
          >
            ...
            <Button
              ...
              size="icon"
              onClick={handleClose}
              className="absolute top-3 right-3 md:top-4 md:right-4 z-50 h-8 w-8 rounded-full bg-white hover:bg-gray-100 shadow-sm"
            >
              <X className="h-4 w-4" />
            </Button>
